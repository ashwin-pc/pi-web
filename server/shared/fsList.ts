...
export async function listDirectories(pathValue: string, fallback = process.cwd()): Promise<DirectoryListing> {
  const resolved = await assertDirectory(pathValue, fallback);

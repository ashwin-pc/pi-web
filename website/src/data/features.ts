...
export const featureRoutes = [
  {
    ...
    capabilities: ['Responsive workspace', 'Installable PWA', 'Saved drafts', 'Completion alerts', 'Token handoff'],
  },
  {
    ...
    capabilities: ['Persistent sessions', 'Quick tabs', 'Pinned · Parked · Bookmarks', 'Queues', 'Branches'],
  },
  {
    slug: 'rich-results',
    ...
    capabilities: ['Rich transcripts', 'Tool activity', 'Mermaid', 'Interactive HTML', 'Artifact gallery'],
  },
  {
    ...
    capabilities: ['Stop and steer', 'Models and context', 'Workspace files', 'Shared diffs', 'Git inspection'],
  },

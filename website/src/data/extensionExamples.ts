...
export const extensionExamples = [
  ...
  { id: 'artifact-reference', title: 'Artifact reference', file: 'artifact-reference.ts', surface: 'Artifact action', status: 'opt-in', outcome: 'Show artifact metadata and a ready-to-copy Markdown link.', adaptPrompt: 'Adapt this action to include an artifact reference in a project handoff.' },
